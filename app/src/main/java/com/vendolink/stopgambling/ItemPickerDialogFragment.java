...
/**
 * Dialog howMuchFragment that allows user to select an item from a list
 */
public class ItemPickerDialogFragment extends DialogFragment {
     ...
     *
     * If the owning Activity implements this interface, then the howMuchFragment will
    ...
    public interface OnDismissListener {
        void onDismiss(ItemPickerDialogFragment fragment);
    }
    ...
    public void onDismiss(DialogInterface dialogInterface){
        ...
        try{
            OnDismissListener listener = (OnDismissListener) getActivity();
            listener.onDismiss(ItemPickerDialogFragment.this);
        } catch(Exception e){
            Log.d("LOG: ", getActivity().toString());
        }
    }
